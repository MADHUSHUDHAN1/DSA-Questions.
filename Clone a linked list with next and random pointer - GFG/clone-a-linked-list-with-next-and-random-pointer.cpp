...
class Solution
{
    ...
    Node *copyList(Node *head)
    {
       ...
       while(current != NULL)
       {
         copyCurrent = mymap[current];
         copyCurrent->next = mymap[current->next];
         copyCurrent->arb = mymap[current->arb];
         current = current->next;
       }
